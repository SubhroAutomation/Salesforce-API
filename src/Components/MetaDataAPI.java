...
public class MetaDataAPI {
    ...
    public static void createProfileFieldLvlSecurityArray () throws IOException, ConnectionException{
    	...
    	try{
    		...
    		System.out.println("****************************************************************");
    		System.out.println("        Setting FLS settings in salesforce for Profiles:       ");
    		System.out.println("****************************************************************");
    		FileOperations.writeToLog("****************************************************************");
    		FileOperations.writeToLog("        Setting FLS settings in salesforce for Profiles:       ");
    		FileOperations.writeToLog("****************************************************************");
    		...
    		while(iterator.hasNext()) { //parse through all the profiles one by one
    			...
    			/*if (iCountOfProfilesNotMoreThan10 == 0){
    				System.out.println("Forming metadata for array of following 10 profiles: ");
    				FileOperations.writeToLog("Forming metadata for array of following 10 profiles: ");
    			}
    			
    			System.out.print(iProfileCount + ". " + strProfile + ", ");
    			FileOperations.writeToLog(iProfileCount + ". " + strProfile + ", ", false);
    			iProfileCount++;*/
    			...
    			if (iArraySize > 0){ // if there are combinations of "Obj # Access Lvl # RecType # Default" for the profile
    			    ...
    			    if (alFieldPermissions.size() > 0){
    			    	...
    			    	strListOfProf = strListOfProf + iProfileCount + ". " + strProfile + " |";
    			    	iProfileCount++;
    ...
    public static void createProfileApexPageAccessArray () throws IOException, ConnectionException{
    	...
    	try{
    		...
    		System.out.println("****************************************************************");
    		System.out.println("        Setting VF Page Access in salesforce for Profiles:       ");
    		System.out.println("****************************************************************");
    		FileOperations.writeToLog("****************************************************************");
    		FileOperations.writeToLog("        Setting VF Page Access in salesforce for Profiles:       ");
    		FileOperations.writeToLog("****************************************************************");
    ...
    public static void createProfileApexClassAccessArray () throws IOException, ConnectionException{
    	...
    	try{
    		...
    		System.out.println("****************************************************************");
    		System.out.println("        Setting Apex Class Access in salesforce for Profiles:       ");
    		System.out.println("****************************************************************");
    		FileOperations.writeToLog("****************************************************************");
    		FileOperations.writeToLog("        Setting Apex Class Access in salesforce for Profiles:       ");
    		FileOperations.writeToLog("****************************************************************");
    ...
    public static void createProfileObjPermAndProfileRecVisibilityArray () throws IOException, ConnectionException{
    	...
    	try{
    		...
    		System.out.println("****************************************************************");
    		System.out.println("        Setting Object Access in salesforce for Profiles:       ");
    		System.out.println("****************************************************************");
    		FileOperations.writeToLog("****************************************************************");
    		FileOperations.writeToLog("        Setting Object Access in salesforce for Profiles:       ");
    		FileOperations.writeToLog("****************************************************************");
    		
    		int iProfileCount = 1; //just for the log
    		
    		Iterator iterator2 = set.iterator();
    		int iProfileCount2 = 0;
    		String strProfile2;
    		...
    		while(iterator.hasNext()) { //parse through all the profiles one by one
    			...
    			if (iCountOfProfilesNotMoreThan10 == 0){
    				System.out.println("--------------------------------------------------------------");
					FileOperations.writeToLog("--------------------------------------------------------------");
					System.out.println("Comparing Object Access in RTP and salesforce for array of following 10 (or less) profiles: ");
					FileOperations.writeToLog("Comparing Object Access in RTP and salesforce for array of following 10 (or less) profiles: ");
					
					boolean bStart=true;
					while(iterator2.hasNext() && bStart==true){
						Map.Entry mentry2 = (Map.Entry)iterator2.next();
						strProfile2 = mentry2.getKey().toString();
						ArrayList <String> alObjAccessLvlRecTypeDef2 = new ArrayList();
		    			alObjAccessLvlRecTypeDef2 = (ArrayList<String>) mentry2.getValue();
		    			if (alObjAccessLvlRecTypeDef2.size()>0){
							System.out.print(iProfileCount2+1 + ". " + strProfile2 + " |");
							FileOperations.writeToLog(iProfileCount2+1 + ". " + strProfile2 + " |", false);
							iProfileCount2++;
							
							if (iProfileCount2%10 == 0)
								bStart=false;
		    			}
	    			}
					//iProfileCount2++;
    			...
    			if (iArraySize > 0){ // if there are combinations of "Obj # Access Lvl # RecType # Default" for the profile
    				System.out.println("Comparing component: " +strProfile);
    				FileOperations.writeToLog("Comparing component: " +strProfile);
    				...
    				for (String strFOA : alObjAccessLvlRecTypeDef){ // parse through all the "Obj # Access Lvl # RecType # Default" combinations one by one
    					...
    					if (!strAccessLvl.equals("BLANK") && !strAccessLvl.equalsIgnoreCase("Default")){	
    						...
    						String strAccessLvltemp = strAccessLvl.replace(",", "");
    						...
    						Boolean bAccessLvinRTPGr8rThnAccessLvlinSFDC = true;
    						String strErrMsg = "Error: for Profile - " +strProfile+ " | Access in RTP: " +strAccessLvltemp+ " | " + "Access in Salesforce: " +strAccessLvltemp+ " ";
    						if (iRecSize > 0){
    		    	...
    		    	if (iCountOfProfilesNotMoreThan10 == 10){
    		    		//FileOperations.writeToLog("--------------------------------------------------------------");
    		    		FileOperations.writeToLog("");
        		    	FileOperations.writeToLog("Setting Object Access for Profile: ");
        		    	FileOperations.writeToLog(strListOfProf);
    			    	//System.out.println("--------------------------------------------------------------");
        		    	System.out.println("");
    			    	System.out.println("Setting Object Access for Profile: ");
    			    	System.out.println(strListOfProf);
    		...
    		if (iCountOfProfilesNotMoreThan10 > 0){
    			//FileOperations.writeToLog("--------------------------------------------------------------");
    			FileOperations.writeToLog("");
		    	FileOperations.writeToLog("Setting Object Access for last few Profile: ");
		    	FileOperations.writeToLog(strListOfProf);
		    	//System.out.println("--------------------------------------------------------------");
		    	System.out.println("");
		    	System.out.println("Setting Object Access for last few Profile: ");
		    	System.out.println(strListOfProf);
		    	updateMetadataFor10Profiles (arrayOf10Profiles, "OBJECT ACCESS");
    		}
    ...
    public static void createProfileLayoutAssignmentsArray () throws IOException, ConnectionException{
    	...
    	try{
    		...
    		System.out.println("****************************************************************");
    		System.out.println("        Assigning Page Layouts in salesforce for Profiles:       ");
    		System.out.println("****************************************************************");
    		FileOperations.writeToLog("****************************************************************");
    		FileOperations.writeToLog("        Assigning Page Layouts in salesforce for Profiles:       ");
    		FileOperations.writeToLog("****************************************************************");
